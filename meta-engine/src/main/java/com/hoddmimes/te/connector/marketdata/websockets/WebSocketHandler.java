...
import com.hoddmimes.te.connector.marketdata.SubscriptionFilter;
import com.hoddmimes.te.connector.marketdata.SubscriptionUpdateCallbackIf;
...
public class WebSocketHandler extends TextWebSocketHandler implements SubscriptionUpdateCallbackIf {
    ...
    public MessageInterface marketDataIpcRequest(MessageInterface pMgmtRequest) {
