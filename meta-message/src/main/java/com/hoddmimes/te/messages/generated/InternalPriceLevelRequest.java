...
import com.google.gson.GsonBuilder;
        ...
        // Add XML defined imports
            ...
            public class InternalPriceLevelRequest implements MessageInterface , EngineMsgInterface
            {
                public static String NAME = "InternalPriceLevelRequest";

            
                    private String mSymbol;
                    private Integer mLevels;
                    private String mRef;
               public InternalPriceLevelRequest()
               {
                
               }

               public InternalPriceLevelRequest(String pJsonString ) {
                    
                    JsonDecoder tDecoder = new JsonDecoder( pJsonString );
                    this.decode( tDecoder );
               }
    
            public InternalPriceLevelRequest setSymbol( String pSymbol ) {
            mSymbol = pSymbol;
            return this;
            }
            ...
            public InternalPriceLevelRequest setLevels( Integer pLevels ) {
            mLevels = pLevels;
            return this;
            }
            ...
            public InternalPriceLevelRequest setRef( String pRef ) {
            mRef = pRef;
            return this;
            }
        ...
        return "InternalPriceLevelRequest";
        }
        ...
        public void encode( JsonEncoder pEncoder) {
            ...
            JsonEncoder tEncoder = new JsonEncoder();
            pEncoder.add("InternalPriceLevelRequest", tEncoder.toJson() );
        ...
        public void decode( JsonDecoder pDecoder) {
            ...
            JsonDecoder tDecoder = pDecoder.get("InternalPriceLevelRequest");
        ...
        public static  Builder getInternalPriceLevelRequestBuilder() {
            return new InternalPriceLevelRequest.Builder();
        }


        public static class  Builder {
          private InternalPriceLevelRequest mInstance;

          private Builder () {
            mInstance = new InternalPriceLevelRequest();
          }
        ...
        public InternalPriceLevelRequest build() {
            return mInstance;
        }
