...
start /B java %JAVA-SWITCHES% -cp ./meta-engine/build/libs/te-1.1.0.jar  com.hoddmimes.te.management.gui.Account -accountdb ./configuration/AccountDefinitions.json
popd