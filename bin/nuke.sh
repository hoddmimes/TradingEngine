...
$_java $JAVA_SWITCHES -cp $DIR/../meta-engine/build/libs/te-$TE_VERSION.jar  com.hoddmimes.te.management.gui.Account -accountdb ./configuration/AccountDefinitions.json
popd
